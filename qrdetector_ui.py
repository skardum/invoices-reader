...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_5.addWidget(self.previous_extractions, 1, 0, 1, 1)
        self.new_batch = QtWidgets.QPushButton(parent=self.centralwidget)
        self.new_batch.setObjectName("new_batch")
        self.gridLayout_5.addWidget(self.new_batch, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.ai_button, 0, 2, 1, 1)
        self.ocr_btn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.ocr_btn.setObjectName("ocr_btn")
        self.gridLayout_4.addWidget(self.ocr_btn, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "بدون"))
        self.comboBox.setItemText(1, _translate("MainWindow", "GEMINI"))
        self.comboBox.setItemText(2, _translate("MainWindow", "OLLAMA"))
        self.label_8.setText(_translate("MainWindow", "خيارات الذكاء الاصطناعي"))
